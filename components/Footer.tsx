...
export const Footer: React.FC = () => {
  ...
  const clinicAddress = 'Dr. Bhanu Kiran Dental Care, Eluru, Andhra Pradesh';
  const mapLink =
    'https://www.google.com/maps/place/Dr.+Bhanu+Kiran+Dental+Care/@16.7145586,81.0981588,17z/data=!3m1!4b1!4m6!3m5!1s0x3a3615407708b80b:0xf2572f3f44c63a8b!8m2!3d16.7145586!4d81.0981588!16s%2Fg%2F11p66w9bnx?entry=ttu';
  ...
  return (
    <footer className="bg-white dark:bg-slate-950 pt-24 pb-12 border-t border-gray-100 dark:border-slate-900 transition-colors duration-300">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-8">
            ...
            <p className="text-secondary dark:text-slate-400 leading-relaxed">
              We provide world-class dental care with specialized treatments for
              the whole family. Led by Dr. Bhanu Kiran, your experience is safe,
          ...
          <div>
            <h4 className="font-bold text-primary dark:text-white text-lg mb-8 uppercase tracking-widest border-b-2 border-medical-blue/20 pb-2 w-fit">
              Quick Links
            </h4>
            <ul className="space-y-4 text-secondary dark:text-slate-400 font-medium">
              <li>
                <button
                  ...
                  className="hover:text-medical-blue transition-all flex items-center gap-2 group hover:translate-x-1"
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-medical-blue opacity-0 group-hover:opacity-100 transition-opacity" />
                  Home
                </button>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-6">
              <a
                ...
                className="flex items-start gap-4 group card-perfect p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-slate-900 border border-transparent hover:border-blue-100 dark:hover:border-slate-800"
              >
                <div className="text-medical-blue mt-1 group-hover:scale-110 transition-transform">
                  <MapPin size={20} />
                </div>
              ...
              >
                <div className="text-medical-accent group-hover:scale-110 transition-transform">
                  <Phone size={20} />
                </div>
                <span className="text-secondary dark:text-slate-400 group-hover:text-medical-blue transition-colors text-sm font-bold">
                  +91 99999 88888
                </span>
              </a>
              <a
                href="mailto:care@bhanu-kiran-dental.com"
                className="flex items-center gap-4 group card-perfect p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-slate-900 border border-transparent hover:border-blue-100 dark:hover:border-slate-800"
              >
          ...
          <div>
            ...
            <p className="text-secondary dark:text-slate-400 mb-6 text-sm leading-relaxed">
              Join our newsletter to receive the latest updates on dental health
              and special offers.
            </p>
            {isSubscribed ? (
              <div className="flex items-center gap-3 text-medical-accent font-bold p-5 bg-red-50 dark:bg-red-900/10 rounded-2xl animate-fade-in border-2 border-medical-accent/20 shadow-lg shadow-red-500/5">
                ...
                <div>
                  ...
                  <p className="text-[10px] opacity-70">
                    Welcome to the healthy smile club.
                  </p>
                </div>
              </div>
            ) : (
              <form className="space-y-3" onSubmit={handleSubscribe}>
                ...
                <p className="text-[10px] text-secondary dark:text-slate-500 px-2 italic">
        ...
        {/* Legal Row with right-side Onyx credit */}
        <div className="pt-10 border-t border-gray-100 dark:border-slate-900 flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Left: text + legal links */}
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8 text-secondary dark:text-slate-500 text-xs sm:text-sm">
            <p className="leading-relaxed">
              © 2024{' '}
              <span className="font-bold text-medical-darkBlue dark:text-slate-300">
                Dr. Bhanu Kiran Dental Clinic
              </span>
              . Proudly keeping smiles bright.
            </p>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 font-semibold uppercase tracking-widest">
              <a
                href="#"
                className="hover:text-medical-blue transition-colors focus:ring-2 focus:ring-medical-blue/20 rounded-md px-1"
              >
                Privacy
              </a>
              <a
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs sm:text-sm font-semibold tracking-wider uppercase bg-medical-blue text-white px-4 py-2 rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg active:scale-95 transition-all whitespace-nowrap"
          >
            Designed by <span className="font-extrabold ml-1">Onyx</span>
          </a>
        </div>
      </div>
    </footer>
