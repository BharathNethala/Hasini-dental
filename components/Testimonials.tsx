...
export const Testimonials: React.FC = () => {
  ...
  const reviews = [
    ...
    },
    {
      name: 'venu babu',
      role: 'Local Guide',
      text: "I have got cleaned my teeth here, Dr. Kalyani Mam treated me very well and did the treatment very carefully. I recommend this dental clinic.",
      rating: 5,
      date: '3 months ago',
    ...
    },
    {
      ...
      text: "Excellent service and very professional staff. Dr. Kalyani Mam explained the procedure clearly and made me feel at ease throughout the treatment.",
      rating: 5,
      date: '1 month ago',
    ...
    },
    {
      name: 'Anjali Gupta',
      role: 'Local Resident',
      text: "Got my wisdom tooth extracted here. It was completely painless! Dr.Kalyanis's hand is very steady. Highly recommended.",
      rating: 5,
      date: '2 weeks ago',
    ...
    <section id="reviews" className="py-24 bg-white dark:bg-slate-950 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="container mx-auto px-6 relative z-10">
                    ...
                    {rev.ownerResponse && (
                      <div className="mt-auto pt-8 border-t border-gray-200 dark:border-slate-800">
                        <div className="flex gap-4 items-start bg-white dark:bg-slate-800 p-5 rounded-2xl shadow-sm">
                          ...
                          <div>
                            <p className="font-bold text-sm text-primary dark:text-white">Rainbow Dental clinic (Owner)</p>
        ...
        <div className="text-center mt-16 reveal">
          <a 
            href="https://www.google.com/maps/search/Rainbow+Dental+Clinic+reviews" 
            target="_blank" 
